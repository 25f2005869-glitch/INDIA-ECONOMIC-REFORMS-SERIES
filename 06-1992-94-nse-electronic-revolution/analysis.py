...
DATASET_PATH = Path(__file__).resolve().parent / "nse_revolution_data.csv"
...
class TestNSERevolutionDataLoad(unittest.TestCase):
    def test_nse_revolution_csv_loads(self):
        df = load_dataset()
